...
<section id="contactus" class=" py-20 lg:py-[120px] overflow-hidden relative z-10">
         ...
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               ...
               <div class="flex  mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <?php
                     $name_query = "SELECT * FROM site_config WHERE site_key='location'";
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <?php
                     $name_query = "SELECT * FROM site_config WHERE site_key='phone'";
                     $name_result = mysqli_query($conn, $name_query);
                     $row = $name_result->fetch_assoc();
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <?php
                     $name_query = "SELECT * FROM site_config WHERE site_key='email'";
                     $name_result = mysqli_query($conn, $name_query);
                     $row = $name_result->fetch_assoc();
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
               <form action="#" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-6">
                     <input type="email" placeholder="Your Email" name="email" class="
                        w-full
                        rounded
                        py-3
                        px-[14px]
                  ...
                  <div class="mb-6">
                     <input type="text" placeholder="Your Phone" name="phone" class="
                        w-full
                        rounded
                        py-3
                        px-[14px]
                  ...
                  <div class="mb-6">
                     <textarea rows="6" placeholder="Your Message" name="message" class="
                        w-full
                        rounded
                        py-3
                        px-[14px]
